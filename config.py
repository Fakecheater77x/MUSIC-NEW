...
OWNER_ID = int(getenv("OWNER_ID", 7094869342))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Fakecheater77x/MUSIC-NEW",
)
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Yaaaro_Ki_Mehfil")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/njijy3.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://files.catbox.moe/vy1o4c.jpg"
)
